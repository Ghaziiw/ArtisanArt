...
describe('UserService', () => {
  ...
  describe('findAll', () => {
    it('should apply filters', async () => {
      ...
      const filters = { email: 'mayssa@example.com', name: 'John Doe' };
  ...
  describe('update profile', () => {
    it('should update user profile when data is valid', async () => {
      ...
      const existingUser = { id: userId, name: 'Old', email: 'old@mail.com' };
    ...
    it('should throw BadRequestException if user not found', async () => {
      ...
      await expect(service.updateProfile(userId, updatedData)).rejects.toThrow(
        BadRequestException,
      );
